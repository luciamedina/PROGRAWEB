...
--
-- Volcar la base de datos para la tabla `evt_actividades`
--
...
--
-- Estructura de tabla para la tabla `evt_asistentes_eventos`
--
...
--
-- Volcar la base de datos para la tabla `evt_asistentes_eventos`
--
...
--
-- Volcar la base de datos para la tabla `evt_asistentes_tipos_usuarios`
--
...
--
-- Volcar la base de datos para la tabla `evt_eventos`
--
...
--
-- Volcar la base de datos para la tabla `evt_eventos_tipos_usuarios`
--
...
--
-- Volcar la base de datos para la tabla `evt_tipos_usuarios`
--
...
--
-- Estructura de tabla para la tabla `evt_usuarios_detalle`
--

CREATE TABLE IF NOT EXISTS `evt_usuarios_detalle` (
...
--
-- Volcar la base de datos para la tabla `evt_usuarios_detalle`
--
...
ALTER TABLE `evt_actividades`
  ADD CONSTRAINT `public@002eevt_actividades_ibfk_1` FOREIGN KEY (`id_evento`) REFERENCES `evt_eventos` (`id_evento`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `evt_asistentes_eventos`
--
ALTER TABLE `evt_asistentes_eventos`
  ADD CONSTRAINT `public@002eevt_asistentes_eventos_ibfk_1` FOREIGN KEY (`id_actividad`) REFERENCES `evt_actividades` (`id_actividad`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `evt_asistentes_tipos_usuarios`
--
ALTER TABLE `evt_asistentes_tipos_usuarios`
  ADD CONSTRAINT `public@002eevt_asistentes_tipos_usuarios_ibfk_2` FOREIGN KEY (`id_tipo_usuario`) REFERENCES `evt_tipos_usuarios` (`id_tipo_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `public@002eevt_asistentes_tipos_usuarios_ibfk_1` FOREIGN KEY (`id_asistente`) REFERENCES `evt_usuarios_detalle` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `evt_eventos_tipos_usuarios`
--
ALTER TABLE `evt_eventos_tipos_usuarios`
  ADD CONSTRAINT `public@002eevt_eventos_tipos_usuarios_ibfk_2` FOREIGN KEY (`id_evento`) REFERENCES `evt_eventos` (`id_evento`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `public@002eevt_eventos_tipos_usuarios_ibfk_1` FOREIGN KEY (`id_tipo_usuario`) REFERENCES `evt_tipos_usuarios` (`id_tipo_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
